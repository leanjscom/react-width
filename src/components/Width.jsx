...
export class Width extends React.Component {
  ...
  constructor (props, context) {
    ...
    this.deferTime = null
    this.extraLargeWidth = props.extraLargeWidth || extraLargeWidth || defaultExtraLargeWidth
    ...
    this.resizeInterval = props.resizeInterval || resizeInterval || defaultResizeInterval
  }
  ...
  (OuterComponent) => {
    ...
    class WithWidth extends Width {
      constructor (props, context) {
        ...
        this.extraLargeWidth = extraLargeWidth || width.extraLargeWidth || defaultExtraLargeWidth
        ...
        this.resizeInterval = resizeInterval || width.resizeInterval || defaultResizeInterval
      }
